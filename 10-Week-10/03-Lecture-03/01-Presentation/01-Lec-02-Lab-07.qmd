...
__Direction of the relationship:__ _____________
...
- Compare those correlation coefficients that we computed
- Do we need to delete those outliers? Why or why not?
