...
- Visualizing One Categorical and One Quantitative Variable
...
Let's use `bwt` variable which is a quantitative variable indicating birth weight in ounces
...
We are visualizing a single quantitative and single categorical variable by using `geom_boxplot`
